  ...
  return (
    ...
    <div className="max-w-md w-full bg-[#e4c8a2] text-[#560106] rounded-xl shadow-lg p-8">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          <label className="block text-sm font-medium mb-1">Recipent Name</label>
          <input
            type="text"
            name="recipentName"
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Recipent Email</label>
          <input
            type="email"
            name="recipentEmail"
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#560106] focus:border-[#560106] outline-none transition-all"
            placeholder="your@email.com"
            value={formData.recipentEmail}
            onChange={handleInputChange}
            required
          />
        </div>
